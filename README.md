...
```bash
> git clone https://github.com/Hendra088/HENDRA03
...
### Information
- Change ownerNumber on [this section](https://github.com/RavaAchmad/GaroxBot/blob/main/HandleMsg.js#L136)
- Change groupLimit on [this section](https://github.com/RavaAchmad/GaroxBot/blob/master/settings/setting.json#L3)
- Change memberLimit on [this section](https://github.com/RavaAchmad/whatsapp-bo2t/blob/master/settings/setting.json#L4)
- Change prefix on [this section](https://github.com/RavaAchmad/GaroxBot/blob/master/settings/setting.json#L5)
- Change menu on [this section](https://github.com/RavaAchmad/GaroxBot/blob/master/lib/menu.js#L32)
- Add kata kasar on [this section](https://github.com/RavaAchmad/GaroxBot/blob/master/lib/kataKotor.js#L8)
- Change all apiKey on [this section](https://github.com/RavaAchmad/GaroxBot/blob/master/settings/api.json)
